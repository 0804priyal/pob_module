    ...
    function (
        ...
        return Component.extend({
            ...
            initObservable: function ()
            {
                ...
                {
                    if (JSON.stringify(totals) == JSON.stringify(currentTotals))
                        return;
            ...
            {
                var self = this;
                var params = { apiKey: self.config().stripeJsKey, locale: self.config().stripeJsLocale };
