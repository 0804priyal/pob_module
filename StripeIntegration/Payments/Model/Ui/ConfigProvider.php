...
class ConfigProvider implements ConfigProviderInterface
{
    ...
    public function getConfig()
    {
        ...
        {
            $shouldUseSetupIntents = $this->setupIntent->shouldUseSetupIntents();
            if ($shouldUseSetupIntents)
                $setupIntent = $this->setupIntent->createForCheckout();
            else
                $setupIntent = null;
            ...
            $data['payment'][self::CODE]['useSetupIntents'] = $shouldUseSetupIntents;
            $data['payment'][self::CODE]['setupIntentClientSecret'] = $setupIntent;
