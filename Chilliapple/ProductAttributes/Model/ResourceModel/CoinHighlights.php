...
class CoinHighlights extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    /**
     * Event Manager
     * 
    ...
    {
        $this->_init('chilliapple_coin_highlights', 'entity_id');
    }
    ...
    public function saveCoinHighlightsAttribute($product){
        ...
        if(isset($customAttributes['coin_highlight']) && !empty($customAttributes['coin_highlight'])){

            $attributes = $customAttributes['coin_highlight'];
        ...
        if($attributes){
            foreach($attributes as $attribute){
                $insertRow = []; 
                $insertRow['coin_highlight'] = $attribute['coin_highlight']; 
