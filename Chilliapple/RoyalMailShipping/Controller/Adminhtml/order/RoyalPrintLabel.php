...
namespace Chilliapple\RoyalMailShipping\Controller\Adminhtml\order;
...
class RoyalPrintLabel extends \Magenticity\RoyalMailShipping\Controller\Adminhtml\order\RoyalPrintLabel
{
    ...
    private $defaultSourceProvider;
     ...
     public function __construct(
        ...
        parent::__construct($context, $orderManager, $directoryList, $convertOrder, $trackFactory,
          $ResourceConnection,$fileFactory,$shipmentManager, $filesystem, $shipmentNotifier, $orderFactory,
          $resultRawFactory, $dataHelper, $ServiceIntegrationCollection, $developConfig);
    ...
    public function assignSourceCode($shipment, $order)
    {
    ...
    public function execute()
    {
        ...
        if ($orderEntityId) {
            ...
            if (!$order->hasShipments() && $ShipmentFlag) {
                ...
                $shipment = $this->assignSourceCode($shipment, $order);
                $flag = '0';
