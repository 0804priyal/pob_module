    ...
    protected function massAction(AbstractCollection $collection)
    {
        ...
        if (empty($status)) {
            ...
            if ($countNonCancelOrder && $countUpdatedOrders) {
                ...
                $this->messageManager->addErrorMessage(
                    __('The status of these orders cannot be changed. You may enable this option in the Order Manager settings. The order can\'t be changed from canceled status to another')
                );
            }
